...
type TiktokRoute = Record<string, RouteConfig>;

const TikTok = () => {
    const [funcToEjec, setFuncToEjec] = useState("");
    const [isOff, setIsOff] = useState(false);

    tiktokRoutes.map((buttonName, index) => {
        console.log(Object.values(buttonName)[0].keySender)
    })
        ...
        <div className="h-[100vh] flex flex-row bg-white">
            ...
            >
                <div className="flex flex-col items-center justify-between w-[20%] h-full">
                    ...
                    >
                        {tiktokRoutes.map((buttonName, index) => {
                            const route = Object.keys(buttonName)[0]
                            return (
                                <ButtonAnimation
                                    disabled={isOff ? true : false}
                ...
                <div className="flex flex-col w-full h-full">
                    <Webview url="https://www.tiktok.com/" app="tiktok-webview" />
                </div>
            </div>
        </div>
    );
