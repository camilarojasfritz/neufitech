  ...
  return (
    <div className="w-full h-screen flex flex-row justify-between p-12 gap-12 bg-zinc-900">
      <div className="flex flex-col justify-between">
        <button className="w-36 h-36 border rounded-md font-medium text-xl text-white">
          SUSPENDER
        </button>
        ...
        <button
            ...
            className="w-36 h-36 border rounded-md font-medium text-xl text-white"
          >
            SALIR
          </button>
      </div>
      ...
      <div className="relative h-full w-[45%] bg-white rounded-lg flex justify-center items-center">
        ...
        <ButtonAnimation
          ...
          size="w-36 h-36 rounded-bl-md rounded-tr-md"
          text="CABEZA"
        />
      ...
      <div className="flex flex-col justify-between items-center w-[45%] bg-zinc-900">
        <div className="flex flex-row gap-2">
          <button className="w-44 h-28 border rounded-md font-medium text-xl text-white">
            LOCALICACION RAPIDA
          </button>
          <button
            onClick={() => setPosition(!position)}
            className="w-44 h-28 border rounded-md font-medium text-xl text-white"
          >
            GIRAR
          </button>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-row gap-2">
            ...
            <button className="flex justify-center items-center w-44 h-28 border rounded-md text-xl text-white">
              <Image
                src={flechaArriba}
                alt="flechaAbajo"
                width={60}
