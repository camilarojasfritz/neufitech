      ...
      <div className="bg-zinc-900 flex flex-col w-full h-full gap-8 pt-4 p-2">
        <div className="flex flex-row justify-between items-center">
          <ButtonAnimation
            ...
            //svg='<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#FFFF" fill-rule="evenodd" d="M5,2 C5,0.895431 5.89543,0 7,0 L9,0 C10.1046,0 11,0.895431 11,2 L11,3 L14,3 C14.5523,3 15,3.44772 15,4 C15,4.55228 14.5523,5 14,5 L13.8462,5 L13.142,14.1534 C13.0619,15.1954 12.193,16 11.1479,16 L4.85206,16 C3.80699,16 2.93811,15.1954 2.85795,14.1534 L2.15385,5 L2,5 C1.44772,5 1,4.55228 1,4 C1,3.44772 1.44772,3 2,3 L5,3 L5,2 Z M7,3 L9,3 L9,2 L7,2 L7,3 Z M4.15975,5 L4.85206,14 L11.1479,14 L11.8402,5 L4.15975,5 Z"></path> </g></svg>'
            propClass="w-[100px] h-[64px] flex justify-center items-center"
          />
          <div className="flex gap-2">
            <ButtonAnimation
